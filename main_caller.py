...
output_real_counter = rnn.accessToPlaceHolders()
...
for i in range(100000):
    ...
    #       output_gap)
    # print("############")
    # print(input_session_length)
    # print(output_session_length)
    # print("############")
    # print(user_numbers)
    #    raise(Exception())
    # get states
    ...
    if i % 100 == 0:
        s = sess.run([merged_summary, pm1, pm2, g1, g2, real_loss_1, real_loss_2], feed_dict={input_time: input_gap,
                                                                                              input_users: user_numbers,
                                                                                              input_genre_count: input_session_length,
                                                                                              output_real_counter: output_session_length,
                                                                                              output_real_time: output_gap,
